  ...
  return (
    <PropertyContainer>
      <PropertyWrapper>
        ...
        <PropertyCol>
          <WrapperImage href="/details" title={`Ver detalhes do imóvel ${title}`}>
            <PriceTag>{price}</PriceTag>
            <Image width={400} height={200} style={{ maxWidth: '400px', height: 'auto' }} src={imageUrl} alt={`Imóvel ${title} em destaque`} />
          </WrapperImage>
        </PropertyCol>
      </PropertyWrapper>
    </PropertyContainer>
